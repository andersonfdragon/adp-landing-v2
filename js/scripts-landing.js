...
$("#btn_nav_fixed_xs").on('click', function() {
    ...
    if ($("#btn_nav_fixed_xs").hasClass("menu-desplegado")){
        $("#img_flecha_fixed").replaceWith('<img id="img_flecha_fixed" src="images/cerrar-nav-fixed-xs.png" alt="Contactenos" class="margin-img-contacto-xs">');
    }else{
        $("#img_flecha_fixed").replaceWith('<img id="img_flecha_fixed" src="images/desplegar-menu-xs-fixed.png" alt="Contactenos" class="margin-img-contacto-xs">');
    }
});
